...
from src.models.time_varying_model import GMMCausalModel
...
class DCP(GMMCausalModel):

    model_type = None  # Will be defined in subclasses
    possible_model_types = {'encoder', 'decoder'}

    def __init__(self, args: DictConfig,
                 dataset_collection: Union[SyntheticDatasetCollection, RealDatasetCollection],
    ...
    def set_hparams(model_args: DictConfig, new_args: dict, input_size: int, model_type: str):
        ...
        if 'gmm_n_components' in new_args:
            sub_args.gmm_n_components = new_args['gmm_n_components']
...
class DCPDecoder(DCP):

    model_type = 'decoder'

    def __init__(self, args: DictConfig,
                 encoder: DCPEncoder = None,
                 dataset_collection: Union[SyntheticDatasetCollection, RealDatasetCollection] = None,
